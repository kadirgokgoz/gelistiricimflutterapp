          ...
          slivers: <Widget>[
            SliverAppBar(shape: RoundedRectangleBorder(borderRadius: BorderRadius.only(bottomRight: Radius.circular(30),bottomLeft: Radius.circular(30))),
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Image.asset("assets/image_04.jpg", fit: BoxFit.cover),
              ),
            ),
    ...
    return Stack(
            children: <Widget>[
              GestureDetector(onTap: (){
                //Navigator.push(context, MaterialPageRoute(builder: (context)=> ArticleSinglePage(article: articles[index],)));
              },
                child: Container(
